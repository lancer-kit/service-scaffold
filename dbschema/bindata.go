...
func migrations001_baseSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/001_base.sql", size: 254, mode: os.FileMode(420), modTime: time.Unix(1556966079, 0)}
...
func migrations002_add_buzz_typeSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/002_add_buzz_type.sql", size: 454, mode: os.FileMode(420), modTime: time.Unix(1556966131, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
